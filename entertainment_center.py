...
def main():
    ...
    transformers_5 = media.Movie("Transformers 5",
                                 ...
                                 "https://i2.wp.com/teaser-trailer.com/wp-content/uploads/Transformers-5-Two-Worlds-Collide.jpg?ssl=1",
    ...
    Schindler_s_List = media.Movie("Schindler's List",
                                   ...
                                   "https://lh3.googleusercontent.com/-WrkylZR-_JU/Vm_lwcO7hcI/AAAAAAAAjVg/ocoIjZ7GUZA/w1024-h1516/schindlers%2Blist%2Bposter.png",
    ...
    movies = [toy_story_3, transformers_5, matrix, Schindler_s_List, spectre, res_evil
              ]
